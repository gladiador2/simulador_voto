 ...
 */
function inicio_status_battery({ batteries, modulo, plugged_state_AC }) {
    currentBatteryData = batteries;
    if (plugged_state_AC !== undefined) {
        currentPlugged_state_AC = plugged_state_AC;
    }
    ...
    return new Promise((resolve, reject) => {
        ...
        fetch_template("baterias", "partials").then((template_header) => {
            const html_header = template_header({
                ...
                data_plugged_state_AC: currentPlugged_state_AC
            });
